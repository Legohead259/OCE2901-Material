...
# global variables
MAX_MEAS = 100  # max number of readings in the session, so that we don't create an infinite loop
AVG_MEAS = 5  # for each reading, take this many measurements and average them
SER_PORT = 'COM18'  # serial port the device is connected to
