...
A = np.array([[1.064707, -0.041684, 0.056644],  # 'A^-1' matrix from Magneto
              [-0.041684, 1.087778, -0.034824],
              [0.056644, -0.034824, 1.025000]])
# 'Combined bias (b)' vector from Magneto
b = np.array([0.247750, 0.203623, 0.017483])
